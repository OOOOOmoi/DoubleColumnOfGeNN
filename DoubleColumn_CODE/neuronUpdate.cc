...
;
struct MergedNeuronUpdateGroup9
 {
    unsigned int* denDelayPtrInSyn2;
    unsigned int* denDelayPtrInSyn6;
    float* denDelayInSyn6;
...
;
struct MergedNeuronUpdateGroup10
 {
    unsigned int* denDelayPtrInSyn10;
    unsigned int* denDelayPtrInSyn6;
    float* inSynInSyn7;
...
;
__device__ __constant__ MergedNeuronSpikeQueueUpdateGroup0 d_mergedNeuronSpikeQueueUpdateGroup0[34];
...
__device__ __constant__ MergedNeuronUpdateGroup1 d_mergedNeuronUpdateGroup1[6];
void pushMergedNeuronUpdateGroup1ToDevice(unsigned int idx, unsigned int* denDelayPtrInSyn7, unsigned int* denDelayPtrInSyn4, float* inSynInSyn5, float* denDelayInSyn5, unsigned int* denDelayPtrInSyn5, float* inSynInSyn6, float* denDelayInSyn6, unsigned int* denDelayPtrInSyn6, float* inSynInSyn7, float* denDelayInSyn7, float* denDelayInSyn4, float* inSynInSyn8, float* denDelayInSyn8, unsigned int* denDelayPtrInSyn8, float* inSynInSyn9, float* denDelayInSyn9, unsigned int* denDelayPtrInSyn9, float* inSynInSyn10, float* denDelayInSyn10, unsigned int* denDelayPtrInSyn10, float* denDelayInSyn1, unsigned int* spkCnt, unsigned int* spk, scalar* V, scalar* RefracTime, float* inSynInSyn0, float* denDelayInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, unsigned int* denDelayPtrInSyn1, float* inSynInSyn2, float* denDelayInSyn2, unsigned int* denDelayPtrInSyn2, float* inSynInSyn3, float* denDelayInSyn3, unsigned int* denDelayPtrInSyn3, float* inSynInSyn4, unsigned int numNeurons, scalar Ioffset) {
    MergedNeuronUpdateGroup1 group = {denDelayPtrInSyn7, denDelayPtrInSyn4, inSynInSyn5, denDelayInSyn5, denDelayPtrInSyn5, inSynInSyn6, denDelayInSyn6, denDelayPtrInSyn6, inSynInSyn7, denDelayInSyn7, denDelayInSyn4, inSynInSyn8, denDelayInSyn8, denDelayPtrInSyn8, inSynInSyn9, denDelayInSyn9, denDelayPtrInSyn9, inSynInSyn10, denDelayInSyn10, denDelayPtrInSyn10, denDelayInSyn1, spkCnt, spk, V, RefracTime, inSynInSyn0, denDelayInSyn0, denDelayPtrInSyn0, inSynInSyn1, denDelayPtrInSyn1, inSynInSyn2, denDelayInSyn2, denDelayPtrInSyn2, inSynInSyn3, denDelayInSyn3, denDelayPtrInSyn3, inSynInSyn4, numNeurons, Ioffset, };
...
__device__ __constant__ MergedNeuronUpdateGroup4 d_mergedNeuronUpdateGroup4[3];
void pushMergedNeuronUpdateGroup4ToDevice(unsigned int idx, float* denDelayInSyn6, unsigned int* denDelayPtrInSyn3, float* inSynInSyn4, float* denDelayInSyn4, unsigned int* denDelayPtrInSyn4, float* inSynInSyn5, float* denDelayInSyn5, unsigned int* denDelayPtrInSyn5, float* inSynInSyn6, float* denDelayInSyn3, unsigned int* denDelayPtrInSyn6, float* inSynInSyn7, float* denDelayInSyn7, unsigned int* denDelayPtrInSyn7, float* inSynInSyn8, float* denDelayInSyn8, unsigned int* denDelayPtrInSyn8, float* inSynInSyn3, unsigned int* denDelayPtrInSyn2, float* denDelayInSyn2, float* inSynInSyn2, unsigned int* denDelayPtrInSyn1, float* denDelayInSyn1, float* inSynInSyn1, unsigned int* denDelayPtrInSyn0, float* denDelayInSyn0, float* inSynInSyn0, scalar* RefracTime, scalar* V, unsigned int* spk, unsigned int* spkCnt, unsigned int numNeurons, scalar Ioffset) {
    MergedNeuronUpdateGroup4 group = {denDelayInSyn6, denDelayPtrInSyn3, inSynInSyn4, denDelayInSyn4, denDelayPtrInSyn4, inSynInSyn5, denDelayInSyn5, denDelayPtrInSyn5, inSynInSyn6, denDelayInSyn3, denDelayPtrInSyn6, inSynInSyn7, denDelayInSyn7, denDelayPtrInSyn7, inSynInSyn8, denDelayInSyn8, denDelayPtrInSyn8, inSynInSyn3, denDelayPtrInSyn2, denDelayInSyn2, inSynInSyn2, denDelayPtrInSyn1, denDelayInSyn1, inSynInSyn1, denDelayPtrInSyn0, denDelayInSyn0, inSynInSyn0, RefracTime, V, spk, spkCnt, numNeurons, Ioffset, };
...
__device__ __constant__ MergedNeuronUpdateGroup5 d_mergedNeuronUpdateGroup5[6];
void pushMergedNeuronUpdateGroup5ToDevice(unsigned int idx, float* denDelayInSyn9, unsigned int* denDelayPtrInSyn5, float* inSynInSyn6, float* denDelayInSyn6, unsigned int* denDelayPtrInSyn6, float* inSynInSyn7, float* denDelayInSyn7, unsigned int* denDelayPtrInSyn7, float* inSynInSyn8, float* denDelayInSyn8, unsigned int* denDelayPtrInSyn8, float* inSynInSyn9, float* denDelayInSyn5, unsigned int* denDelayPtrInSyn9, float* inSynInSyn10, float* denDelayInSyn10, unsigned int* denDelayPtrInSyn10, float* inSynInSyn11, float* denDelayInSyn11, unsigned int* denDelayPtrInSyn11, float* inSynInSyn12, float* denDelayInSyn12, unsigned int* denDelayPtrInSyn12, unsigned int* denDelayPtrInSyn1, unsigned int* spkCnt, unsigned int* spk, scalar* V, scalar* RefracTime, float* inSynInSyn0, float* denDelayInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, float* denDelayInSyn1, float* inSynInSyn2, float* denDelayInSyn2, unsigned int* denDelayPtrInSyn2, float* inSynInSyn3, float* denDelayInSyn3, unsigned int* denDelayPtrInSyn3, float* inSynInSyn4, float* denDelayInSyn4, unsigned int* denDelayPtrInSyn4, float* inSynInSyn5, unsigned int numNeurons, scalar Ioffset) {
    MergedNeuronUpdateGroup5 group = {denDelayInSyn9, denDelayPtrInSyn5, inSynInSyn6, denDelayInSyn6, denDelayPtrInSyn6, inSynInSyn7, denDelayInSyn7, denDelayPtrInSyn7, inSynInSyn8, denDelayInSyn8, denDelayPtrInSyn8, inSynInSyn9, denDelayInSyn5, denDelayPtrInSyn9, inSynInSyn10, denDelayInSyn10, denDelayPtrInSyn10, inSynInSyn11, denDelayInSyn11, denDelayPtrInSyn11, inSynInSyn12, denDelayInSyn12, denDelayPtrInSyn12, denDelayPtrInSyn1, spkCnt, spk, V, RefracTime, inSynInSyn0, denDelayInSyn0, denDelayPtrInSyn0, inSynInSyn1, denDelayInSyn1, inSynInSyn2, denDelayInSyn2, denDelayPtrInSyn2, inSynInSyn3, denDelayInSyn3, denDelayPtrInSyn3, inSynInSyn4, denDelayInSyn4, denDelayPtrInSyn4, inSynInSyn5, numNeurons, Ioffset, };
...
__device__ __constant__ MergedNeuronUpdateGroup6 d_mergedNeuronUpdateGroup6[5];
...
__device__ __constant__ MergedNeuronUpdateGroup9 d_mergedNeuronUpdateGroup9[1];
void pushMergedNeuronUpdateGroup9ToDevice(unsigned int idx, unsigned int* denDelayPtrInSyn2, unsigned int* denDelayPtrInSyn6, float* denDelayInSyn6, float* inSynInSyn6, unsigned int* denDelayPtrInSyn5, float* denDelayInSyn5, float* inSynInSyn5, unsigned int* denDelayPtrInSyn4, float* denDelayInSyn4, float* inSynInSyn4, unsigned int* denDelayPtrInSyn3, float* denDelayInSyn3, float* inSynInSyn3, float* denDelayInSyn2, float* inSynInSyn2, unsigned int* denDelayPtrInSyn1, float* denDelayInSyn1, float* inSynInSyn1, unsigned int* denDelayPtrInSyn0, float* denDelayInSyn0, float* inSynInSyn0, scalar* RefracTime, scalar* V, unsigned int* spk, unsigned int* spkCnt, unsigned int numNeurons) {
    MergedNeuronUpdateGroup9 group = {denDelayPtrInSyn2, denDelayPtrInSyn6, denDelayInSyn6, inSynInSyn6, denDelayPtrInSyn5, denDelayInSyn5, inSynInSyn5, denDelayPtrInSyn4, denDelayInSyn4, inSynInSyn4, denDelayPtrInSyn3, denDelayInSyn3, inSynInSyn3, denDelayInSyn2, inSynInSyn2, denDelayPtrInSyn1, denDelayInSyn1, inSynInSyn1, denDelayPtrInSyn0, denDelayInSyn0, inSynInSyn0, RefracTime, V, spk, spkCnt, numNeurons, };
    CHECK_CUDA_ERRORS(cudaMemcpyToSymbolAsync(d_mergedNeuronUpdateGroup9, &group, sizeof(MergedNeuronUpdateGroup9), idx * sizeof(MergedNeuronUpdateGroup9)));
}
__device__ __constant__ MergedNeuronUpdateGroup10 d_mergedNeuronUpdateGroup10[5];
void pushMergedNeuronUpdateGroup10ToDevice(unsigned int idx, unsigned int* denDelayPtrInSyn10, unsigned int* denDelayPtrInSyn6, float* inSynInSyn7, float* denDelayInSyn7, unsigned int* denDelayPtrInSyn7, float* inSynInSyn8, float* denDelayInSyn8, unsigned int* denDelayPtrInSyn8, float* inSynInSyn9, float* denDelayInSyn9, unsigned int* denDelayPtrInSyn9, float* inSynInSyn10, float* denDelayInSyn10, float* denDelayInSyn6, float* inSynInSyn11, float* denDelayInSyn11, unsigned int* denDelayPtrInSyn11, float* inSynInSyn12, float* denDelayInSyn12, unsigned int* denDelayPtrInSyn12, float* inSynInSyn13, float* denDelayInSyn13, unsigned int* denDelayPtrInSyn13, float* inSynInSyn14, float* denDelayInSyn14, unsigned int* denDelayPtrInSyn14, float* denDelayInSyn2, unsigned int* spkCnt, unsigned int* spk, scalar* V, scalar* RefracTime, float* inSynInSyn0, float* denDelayInSyn0, unsigned int* denDelayPtrInSyn0, float* inSynInSyn1, float* denDelayInSyn1, unsigned int* denDelayPtrInSyn1, float* inSynInSyn2, unsigned int* denDelayPtrInSyn2, float* inSynInSyn3, float* denDelayInSyn3, unsigned int* denDelayPtrInSyn3, float* inSynInSyn4, float* denDelayInSyn4, unsigned int* denDelayPtrInSyn4, float* inSynInSyn5, float* denDelayInSyn5, unsigned int* denDelayPtrInSyn5, float* inSynInSyn6, unsigned int numNeurons, scalar Ioffset) {
    MergedNeuronUpdateGroup10 group = {denDelayPtrInSyn10, denDelayPtrInSyn6, inSynInSyn7, denDelayInSyn7, denDelayPtrInSyn7, inSynInSyn8, denDelayInSyn8, denDelayPtrInSyn8, inSynInSyn9, denDelayInSyn9, denDelayPtrInSyn9, inSynInSyn10, denDelayInSyn10, denDelayInSyn6, inSynInSyn11, denDelayInSyn11, denDelayPtrInSyn11, inSynInSyn12, denDelayInSyn12, denDelayPtrInSyn12, inSynInSyn13, denDelayInSyn13, denDelayPtrInSyn13, inSynInSyn14, denDelayInSyn14, denDelayPtrInSyn14, denDelayInSyn2, spkCnt, spk, V, RefracTime, inSynInSyn0, denDelayInSyn0, denDelayPtrInSyn0, inSynInSyn1, denDelayInSyn1, denDelayPtrInSyn1, inSynInSyn2, denDelayPtrInSyn2, inSynInSyn3, denDelayInSyn3, denDelayPtrInSyn3, inSynInSyn4, denDelayInSyn4, denDelayPtrInSyn4, inSynInSyn5, denDelayInSyn5, denDelayPtrInSyn5, inSynInSyn6, numNeurons, Ioffset, };
    CHECK_CUDA_ERRORS(cudaMemcpyToSymbolAsync(d_mergedNeuronUpdateGroup10, &group, sizeof(MergedNeuronUpdateGroup10), idx * sizeof(MergedNeuronUpdateGroup10)));
}
// ------------------------------------------------------------------------
...
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID1[] = {1792, 3456, 5376, 5696, 25408, 27456, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID2[] = {32320, 34944, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID3[] = {74048, 75776, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID4[] = {77440, 92992, 94656, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID5[] = {94976, 115264, 119808, 174976, 178688, 179776, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID6[] = {180096, 184192, 185792, 188608, 190720, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID7[] = {192192, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID8[] = {213824, 288768, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID9[] = {308672, };
__device__ __constant__ unsigned int d_mergedNeuronUpdateGroupStartID10[] = {322176, 373952, 380992, 382976, 383360, };
...
extern "C" __global__ void updateNeuronsKernel(float t)
 {
    ...
    if(id < 1792) {
        ...
        if(lid < group->numNeurons) {
            ...
            if (lRefracTime <= 0.0f) {
              scalar alpha = ((Isyn + (5.00999987125396729e-01f)) * (4.00000000000000000e+01f)) + (-7.00000000000000000e+01f);
    ...
    if(id >= 1792 && id < 32320) {
        ...
        if(lid < group->numNeurons) {
            ...
            // calculate membrane potential
            if (lRefracTime <= 0.0f) {
              scalar alpha = ((Isyn + group->Ioffset) * (4.00000000000000000e+01f)) + (-7.00000000000000000e+01f);
              lV = alpha - ((9.95012479192682320e-01f) * (alpha - lV));
            }
            else {
              lRefracTime -= DT;
    ...
    // merged5
    if(id >= 94976 && id < 180096) {
        unsigned int lo = 0;
        unsigned int hi = 6;
        while(lo < hi)
         {
            const unsigned int mid = (lo + hi) / 2;
            if(id < d_mergedNeuronUpdateGroupStartID5[mid]) {
                hi = mid;
            }
            else {
                lo = mid + 1;
        ...
        struct MergedNeuronUpdateGroup5 *group = &d_mergedNeuronUpdateGroup5[lo - 1]; 
        const unsigned int groupStartID = d_mergedNeuronUpdateGroupStartID5[lo - 1];
        const unsigned int lid = id - groupStartID;
    ...
    // merged6
    if(id >= 180096 && id < 192192) {
        unsigned int lo = 0;
        unsigned int hi = 5;
        while(lo < hi)
         {
            const unsigned int mid = (lo + hi) / 2;
            if(id < d_mergedNeuronUpdateGroupStartID6[mid]) {
                hi = mid;
            }
            else {
                lo = mid + 1;
        ...
        struct MergedNeuronUpdateGroup6 *group = &d_mergedNeuronUpdateGroup6[lo - 1]; 
        const unsigned int groupStartID = d_mergedNeuronUpdateGroupStartID6[lo - 1];
        const unsigned int lid = id - groupStartID;
    ...
    if(id >= 192192 && id < 213824) {
        ...
        if(lid < group->numNeurons) {
            ...
            float Isyn = 0;
             ...
             {
                // pull inSyn values in a coalesced access
                float linSyn = group->inSynInSyn17[lid];
                float *denDelayFront = &group->denDelayInSyn17[(*group->denDelayPtrInSyn17 * group->numNeurons) + lid];
                linSyn += *denDelayFront;
                *denDelayFront = 0.000000000e+00f;
                Isyn += (9.06346234610090895e-01f) * linSyn;
                linSyn *= (8.18730753077981821e-01f);
                group->inSynInSyn17[lid] = linSyn;
            }
            // test whether spike condition was fulfilled previously
            // calculate membrane potential
            if (lRefracTime <= 0.0f) {
              scalar alpha = ((Isyn + (5.10999977588653564e-01f)) * (4.00000000000000000e+01f)) + (-7.00000000000000000e+01f);
              lV = alpha - ((9.95012479192682320e-01f) * (alpha - lV));
            }
            else {
              lRefracTime -= DT;
    ...
    // merged8
    if(id >= 213824 && id < 308672) {
        unsigned int lo = 0;
        unsigned int hi = 2;
        while(lo < hi)
         {
            const unsigned int mid = (lo + hi) / 2;
            if(id < d_mergedNeuronUpdateGroupStartID8[mid]) {
                hi = mid;
            }
            else {
                lo = mid + 1;
        ...
        struct MergedNeuronUpdateGroup8 *group = &d_mergedNeuronUpdateGroup8[lo - 1]; 
        const unsigned int groupStartID = d_mergedNeuronUpdateGroupStartID8[lo - 1];
        const unsigned int lid = id - groupStartID;
    ...
    // merged9
    if(id >= 308672 && id < 322176) {
        struct MergedNeuronUpdateGroup9 *group = &d_mergedNeuronUpdateGroup9[0]; 
        const unsigned int lid = id - 308672;
    ...
    // merged10
    if(id >= 322176 && id < 385024) {
        unsigned int lo = 0;
        unsigned int hi = 5;
        while(lo < hi)
         {
            const unsigned int mid = (lo + hi) / 2;
            if(id < d_mergedNeuronUpdateGroupStartID10[mid]) {
                hi = mid;
            }
            else {
                lo = mid + 1;
        ...
        struct MergedNeuronUpdateGroup10 *group = &d_mergedNeuronUpdateGroup10[lo - 1]; 
        const unsigned int groupStartID = d_mergedNeuronUpdateGroupStartID10[lo - 1];
        const unsigned int lid = id - groupStartID;
