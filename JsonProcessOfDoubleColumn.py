...
DataPath=os.path.join("/home/yangjinhao/GeNN/userproject/DoubleColumn/custom_Data_Model_3396.json")
file1=os.path.join("/home/yangjinhao/GeNN/userproject/DoubleColumn/SynapsesWeight.txt")
file3=os.path.join("/home/yangjinhao/GeNN/userproject/DoubleColumn/SynapsesNumber.txt")
file2=os.path.join("/home/yangjinhao/GeNN/userproject/DoubleColumn/NeuronNumber.txt")
file4=os.path.join("/home/yangjinhao/GeNN/userproject/MultiArea/AreaDist.txt")
