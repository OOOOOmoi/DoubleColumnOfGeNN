...
const char *FileWeight="/home/yangjinhao/GeNN/userproject/DoubleColumn/SynapsesWeight.txt";
const char *FileSynapseNumber="/home/yangjinhao/GeNN/userproject/DoubleColumn/SynapsesNumber.txt";
const char *FileNeuronNumber="/home/yangjinhao/GeNN/userproject/DoubleColumn/NeuronNumber.txt";
const char *FileDist="/home/yangjinhao/GeNN/userproject/DoubleColumn/AreaDist.txt";
...
map<string,map<string,map<string,map<string,ParaMeters::weightInfo>>>> getSynWeight(){
    ...
    while(file>>tarArea>>tarPop>>srcArea>>srcPop>>wAve>>wSd){
        SynWeight[tarArea][tarPop][srcArea][srcPop].wAve=wAve/1000;
        SynWeight[tarArea][tarPop][srcArea][srcPop].wSd=wSd/1000;
    }
    return SynWeight;
    file.close();
}
